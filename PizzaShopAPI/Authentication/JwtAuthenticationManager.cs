...
namespace PizzaShopAPI.Authentication
{
    ...
    {
        public const string JWT_SECURITY_KEY = "fsfsdfsfefefefeew33r3wsadaadssvsgfeef";
...

        {
            ...
            var signingCredentials = new SigningCredentials(
                ...
                SecurityAlgorithms.HmacSha256); // ky ma JWT
            var securityTokenFescriptor = new SecurityTokenDescriptor
            {
            ...
            var securityToken = jwtSecurityTokenHandler.CreateToken(securityTokenFescriptor);
